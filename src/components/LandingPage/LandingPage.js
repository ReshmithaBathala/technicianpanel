...
function LandingPage() {
  ...
  //   const [filteredTechnicians, setFilteredTechnicians] = useState([]); // New state for filtered technicians
  const navigate = useNavigate();

  useEffect(() => {
    const fetchData = async () => {
      const [locationsData, applianceTypesData, techniciansData] =
        await Promise.all([
          fetch("https://nviribackend.onrender.com/locations").then((res) =>
            res.json()
          ),
          fetch("https://nviribackend.onrender.com/appliance-types").then(
            (res) => res.json()
          ),
          fetch("https://nviribackend.onrender.com/technicians").then((res) =>
            res.json()
          ),
        ]);
      setLocations(locationsData);
      setApplianceTypes(applianceTypesData);
  ...
  return (
    <div className="App-container">
      <nav className="navbar-container">
        <img
          src="https://res.cloudinary.com/dxsi3qcvy/image/upload/v1724841828/blue_logo_hcjzjh.png"
          className="argon-logo"
          alt="Argon"
        />
        <button
          className="logout-btn"
          type="button"
          onClick={() => navigate("/user-login")} // Navigate to login page on click
        >
          Logout
        </button>
      </nav>
      <div className="finding-container">
        ...
        <img
          src="https://res.cloudinary.com/dxsi3qcvy/image/upload/v1724843507/Frame_alpkbe.png"
          className="finding-right-image"
          alt="Finding"
        />
      </div>
      ...
      <div className="book-container">
        ...
        <div className="sub-book-container">
          <div className="sub-book">
            <img
              src="https://res.cloudinary.com/dxsi3qcvy/image/upload/v1724845338/undraw_forms_re_pkrt_1_kgqov5.png"
              className="book-imgs"
            />
            <h1 className="book-sub-head">Provide your appliance details</h1>
            <p className="book-sub-para">
              Let us know your appliance details and your issue.
            </p>
          </div>
          <div className="sub-book">
            <img
              src="https://res.cloudinary.com/dxsi3qcvy/image/upload/v1724845845/Untitled_h7vquu.png"
              className="book-imgs"
            />
          ...
          <div className="sub-book">
            <img
              src="https://res.cloudinary.com/dxsi3qcvy/image/upload/v1724845898/undraw_certification_re_ifll_1_vp7jr3.png"
              className="book-imgs"
            />
